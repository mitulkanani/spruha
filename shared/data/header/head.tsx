  ...
  return (
    <>
      ...
      {/* <Dropdown className="header-element country-selector">
        <Dropdown.Toggle className="nav-link icon country-Flag p-0" variant="">
...
{/* 
      <Dropdown className="header-element cart-dropdown">
        ...
        >
          ...
          <Badge
            bg="primary"
            className="badge bg-primary rounded-pill header-icon-badge d-xl-block d-none"
            id="cart-icon-badge"
          >
            {cartItemCount}
          </Badge>
        ...
        >
          <div className="p-3">
            <div className="d-flex align-items-center justify-content-between">
              ...
              <span className="badge bg-primary rounded-pill" id="cart-data">
                {" "}
                  ...
                  <div className="flex-grow-1">
                    ...
                    <div className="min-w-fit-content d-flex align-items-start justify-content-between">
                      <ul className="header-product-item d-flex">
                        ...
                        <li>
                          {idx.Qtytext}{" "}
                          <span className={idx.background}>{idx.status}</span>
                        </li>
                      </ul>
          ...
          >
            <div className="d-grid">
              <Link
                href="/components/ecommerce/checkout/"
      ...
      <Dropdown className="header-element">
        ...
        >
          ...
          <li>
            <Link
              className="dropdown-item d-flex border-bottom"
              href={`/components/apps/mail/mail-inbox/`}
            >
          ...
          <li>
            <Link
              ...
              href={`/components/pages/notifications-list/`}
            >
              <i className="fe fe-compass fs-16 align-middle me-2"></i>Activity
            </Link>
          </li>
          <li>
            <Link
            ...
            >
              <i className="fe fe-settings fs-16 align-middle me-2"></i>Settings
            </Link>
          </li>
          <li>
            <Link
      ...
      {/* <div
        className="header-element  right-sidebar"
