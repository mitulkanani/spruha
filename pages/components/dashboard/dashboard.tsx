...
import { progressData, recentTransactionsData } from "@/utils/content";
const TodayTask = dynamic(
  () => import("../../../shared/data/dashboard/today-task"),
  { ssr: false }
);
                  ...
                  <Card.Header className="border-bottom-0 pt-0 ps-0 pe-0 pb-2 d-flex">
                    ...
                    <div className="ms-auto d-flex flex-wrap gap-2">
                      ...
                      <Dropdown className="ms-auto d-flex">
                        <Dropdown.Toggle
                          href="#!"
                          className="btn dropdown-toggle btn-sm btn-wave waves-effect waves-light btn-primary d-inline-flex align-items-center"
                          ...
                          <tr key={index} data-index={index}>
                            <td className="fw-medium">
                              <div className="form-check">
                                <input
                                  type="checkbox"
                                  className="form-check-input me-4 rounded"
                                  defaultChecked
                                />
